...
export const russianContent: PortfolioContent = {
  ...
  profile: {
    ...
    summary: '',
    intro: [
      'Веду продукты от идеи до запуска: придумываю, что делать, делаю, выпускаю и потом сопровождаю.',
      'Начал в 2020 году с того, что сам продавал свой софт. Это научило меня тому, что реально происходит с продуктом после релиза, а там и есть основная работа.',
      'Так же работаю и сейчас, над веб-инструментами и AI-системами, обычно с нуля и полностью на себе.',
    ],
  },
  links: [
