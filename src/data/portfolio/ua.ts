...
export const ukrainianContent: PortfolioContent = {
  ...
  profile: {
    ...
    summary: '',
    intro: [
      'Веду продукти від ідеї до запуску: придумую, що робити, роблю, випускаю і далі супроводжую.',
      'У 2020 році я почав сам продавати свій софт. Це навчило мене того, що насправді відбувається з продуктом після релізу, а саме там основна робота.',
      'Так само працюю і зараз, над веб-інструментами та AI-системами, зазвичай з нуля і повністю на собі.',
    ],
  },
  links: [
